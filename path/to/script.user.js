...
(function() {
    ...
    function createEle(tag,styles = {},text = '') {
    ...
    async function init() {
        ...
        const asyncBtn = createEle('button', btnStyles, '上传');
        const asyncConfigBtn = createEle('button', btnStyles, '配置');
    ...
    function initConfigForm() {
        ...
        overlay.style.zIndex = zIndexNum;
        ...
        // 创建同步域名关键词·默认当前域名
        const domainEle = document.createElement('textarea');
        domainEle.placeholder = '同步域名关键词·一行一个';
        domainEle.rows = 3;
